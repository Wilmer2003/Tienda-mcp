...
async def test_mensaje_desconocido_pide_reformular(orquestador):
    ...
    assert "ayud" in r.mensaje.lower() or "reform" in r.mensaje.lower() or "no " in r.mensaje.lower() or "disculp" in r.mensaje.lower()
