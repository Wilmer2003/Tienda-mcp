...
class EventType(str, Enum):
    ...
    NOTION_CONSULTA_INICIADA = "notion.consulta.iniciada"
    NOTION_CONSULTA_EXITOSA = "notion.consulta.exitosa"
    NOTION_CONSULTA_FALLIDA = "notion.consulta.fallida"
    NOTION_FALLBACK_LOCAL = "notion.fallback.local"
